    ...
    public Paciente buscarPorID(Integer id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                logger.info("estoy en busqueda de paciente por id con el id domicilio: " + rs.getInt(6));
        ...
        logger.info("estoy en busqueda de paciente retorno final: "  + paciente );
        return paciente;
    }

    @Override
    public void actualizar(Paciente paciente) {
        logger.info("iniciando la actualizacion vvv de : "+paciente.getNombre()+" con id : "+paciente.getId());
        Connection connection= null;
        DomicilioDAOH2 daoAux= new DomicilioDAOH2();
