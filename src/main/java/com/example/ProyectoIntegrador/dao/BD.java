...
public class BD {
    ...
    //private static final String SQL_DROP_CREATE_TURNOS=" DROP TABLE IF EXISTS TURNOS; " +
            //"CREATE TABLE TURNOS (ID INT AUTO_INCREMENT PRIMARY KEY, ODONTOLOGO_ID INT NOT NULL, PACIENTE_ID INT NOT NULL, " +
    ...
    private static final String SQL_PRUEBA3="INSERT INTO ODONTOLOGOS (MATRICULA, NOMBRE, APELLIDO) VALUES('12345','Carol','Velez'),('678945','Ingrid','Munera')";
    ...
    public static Connection getConnection() throws Exception{
        ...
        return DriverManager.getConnection("jdbc:h2:~/CarolIngrid","sa","sa");
    }
}
